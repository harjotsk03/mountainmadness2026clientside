  ...
  const draw = useCallback(
    (ctx: CanvasRenderingContext2D, width: number, height: number) => {
      ...
      > = {
        idle: {
          blobs: [
            { hue: 220, sat: 60, light: 55, alpha: 0.25 },
            { hue: 260, sat: 50, light: 50, alpha: 0.2 },
            { hue: 200, sat: 55, light: 50, alpha: 0.2 },
            { hue: 240, sat: 45, light: 45, alpha: 0.18 },
            { hue: 280, sat: 40, light: 50, alpha: 0.18 },
          ],
          coreColor: "rgba(100, 120, 200, VAL)",
          coreColorMid: "rgba(130, 145, 200, VAL)",
          glowColor: "rgba(100, 120, 200, VAL)",
          edgeColor: "rgba(120, 140, 200, VAL)",
          particleColor: "rgba(100, 120, 200, VAL)",
        },
        listening: {
          blobs: [
            { hue: 210, sat: 85, light: 55, alpha: 0.55 },
            { hue: 270, sat: 80, light: 50, alpha: 0.5 },
            { hue: 320, sat: 75, light: 50, alpha: 0.45 },
            { hue: 180, sat: 70, light: 45, alpha: 0.4 },
            { hue: 250, sat: 80, light: 48, alpha: 0.4 },
            { hue: 340, sat: 70, light: 55, alpha: 0.35 },
            { hue: 190, sat: 75, light: 50, alpha: 0.3 },
          ],
          coreColor: "rgba(80, 100, 220, VAL)",
          coreColorMid: "rgba(100, 120, 230, VAL)",
          glowColor: "rgba(80, 110, 230, VAL)",
          edgeColor: "rgba(100, 130, 240, VAL)",
          particleColor: "rgba(80, 110, 220, VAL)",
        },
        processing: {
          blobs: [
            { hue: 210, sat: 75, light: 48, alpha: 0.4 },
            { hue: 260, sat: 70, light: 45, alpha: 0.35 },
            { hue: 300, sat: 65, light: 48, alpha: 0.3 },
            { hue: 180, sat: 60, light: 45, alpha: 0.3 },
            { hue: 240, sat: 70, light: 45, alpha: 0.28 },
          ],
          coreColor: "rgba(90, 100, 210, VAL)",
          coreColorMid: "rgba(110, 120, 220, VAL)",
          glowColor: "rgba(80, 100, 210, VAL)",
          edgeColor: "rgba(100, 120, 220, VAL)",
          particleColor: "rgba(90, 110, 210, VAL)",
        },
        speaking: {
          blobs: [
            { hue: 160, sat: 80, light: 45, alpha: 0.55 },
            { hue: 200, sat: 75, light: 45, alpha: 0.5 },
            { hue: 280, sat: 65, light: 48, alpha: 0.4 },
            { hue: 170, sat: 75, light: 45, alpha: 0.45 },
            { hue: 220, sat: 70, light: 45, alpha: 0.38 },
            { hue: 140, sat: 70, light: 45, alpha: 0.35 },
            { hue: 300, sat: 60, light: 48, alpha: 0.3 },
          ],
          coreColor: "rgba(40, 180, 140, VAL)",
          coreColorMid: "rgba(60, 190, 160, VAL)",
          glowColor: "rgba(40, 170, 140, VAL)",
          edgeColor: "rgba(60, 180, 150, VAL)",
          particleColor: "rgba(50, 180, 150, VAL)",
        },
      };
